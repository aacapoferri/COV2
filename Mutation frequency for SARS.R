...
gg<-ggplot(sarscov2, aes(x=Position, y=Frequency)) + geom_point(aes(col=Gene), size=1) + labs(title="Clade G Phase 2", y="Relative Mutation Proportion", x="SARS-CoV-2 Genome") 
